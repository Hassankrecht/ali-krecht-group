<div class="cart-item d-flex align-items-center">
    <img src="{{ $item['image'] ?? '/assets/img/placeholder.png' }}" alt="{{ $item['title_localized'] ?? $item['title'] ?? __('messages.products.hero_title') }}" class="cart-thumb">
    <div class="cart-details ms-2">
        <div class="cart-title">{{ $item['title_localized'] ?? $item['title'] ?? __('messages.common.untitled') }}</div>
